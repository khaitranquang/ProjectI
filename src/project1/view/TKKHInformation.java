...
public class TKKHInformation extends JPanel{
	private JLabel lbCurrentDate;
	private JLabel lbTitle;
	private TableTKKHView tableTKKHView;
	...
	public TableTKKHView getTableTKKHView() {
		return tableTKKHView;
	}
	
	public TKKHInformation() {
	...
	private JPanel createTablePanel() {
		...
		tableTKKHView = new TableTKKHView();
		panel.add(lbTitle, BorderLayout.PAGE_START);
		panel.add(tableTKKHView, BorderLayout.CENTER);
		return panel;
	}
}
