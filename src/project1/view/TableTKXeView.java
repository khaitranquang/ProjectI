...
public class TableTKXeView extends JPanel{
	...
	private String[] title3 = {"STT", "NĂM SẢN XUẤT", "SỐ LƯỢNG"};
	private String[] title4 = {"STT", "NGÀY BẢO TRÌ", "SỐ LƯỢNG"};
	private String[] title5 = {"STT", "NHIÊN LIỆU", "SỐ LƯỢNG"};
	private String[] title6 = {"STT", "TRẠNG THÁI", "SỐ LƯỢNG"};
