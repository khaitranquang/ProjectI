...
public class TableTKNVView extends JPanel {
	...
	private String[] title1 = {"STT", "NGÀY SINH", "SỐ LƯỢNG"};
	private String[] title2 = {"STT", "ĐỊA CHỈ", "SỐ LƯỢNG"};
	private String[] title3 = {"STT", "GIỚI TÍNH", "SỐ LƯỢNG"};
